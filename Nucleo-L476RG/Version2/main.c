...
uint8_t SenderBuff[BUFFER_SIZE*2] = {0};
int16_t processed_buff[BUFFER_SIZE / 2] = {0};
...
int main(void)
{
  ...
  while(1){
		...
		// Get rid of the 8 LSB <= config parameters
		...
		for(i=0; i<BUFFER_SIZE;i++){
  		...
  		//TODO: Pass the info to the rust program and plot
